...
import { ActivityIndicator, ImageStyle, Modal, Pressable, TextStyle, View, ViewStyle } from "react-native"
...
export const MetacriticScreen: FC<DemoTabScreenProps<"Metacritic">> = observer(
    (_props) => {
...
const years = [
    2021, 2022, 2023, 2024
].map((y: number) => ({ label: y.toString(), value: y.toString() }))
